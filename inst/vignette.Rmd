...
In addition to the provided ranking criteria in *ipsr()* or *sumRanks()*, which includes "t.test", "cox", "log2fc", and "kruskal.test", we can also use a Customized function to rank features based on a specified rank criterion. To this end, we can pass a function to the *fun* argument. The function should take *x* and *y* as inputs and output the rank criterion, such as p-values.
