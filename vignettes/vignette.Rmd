...
vignette: >
  %\VignetteIndexEntry{"findIPs: Detect Influential Obseravation for Feature 
  Rankings"}
...
output is identical to using the two-step process.
...
*findIPs* package offers three visualization functions: *plot.ips()*, 
*plotRankScatters()*, and *plotAdaptiveWeights()*. *plot.ips()* can directly 
...
using a scatter plot (Figure 2). Alike *plot.ips()*, *plotRankScatters()* simply 
...
survival." Proceedings of the National Academy of Sciences 102.38 (2005): 13550-13555.doi:10.1073pnas.0506230102  
